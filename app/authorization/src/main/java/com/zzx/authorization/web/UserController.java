...
public class UserController {
	...
	//	User model = JSONObject.parseObject(content, User.class);
	//	userBo.add(model);
	...
	//	int count = userBo.removeById(Long.valueOf(id));
	//	if(count > 0){
	...
	public String del(@PathVariable String id) {
		//userBo.removeById(Long.valueOf(id));
		return "";
	}
