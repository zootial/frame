package com.zzx.zookeeper.support;
...
//	@Before
	public void connect() throws IOException {
		zooKeeper = new ZooKeeper("39.108.192.178:4180", SESSION_TIMEOUT, watcher);
	}
...
//	@Test
	...
	/**
	 * 判断节点是否存在 设置是否监控这个目录节点，这里的 watcher 是在创建 ZooKeeper实例时指定的 watcher <br>
	 * ------------------------------<br>
	 */
//	@Test
...
//	@Test
	...
	/**
	 * 判断节点是否存在, 设置监控这个目录节点的 Watcher <br>
	 * ------------------------------<br>
	 */
//	@Test
...
//	@Test
	public void testGetChild() {
		try {
			zooKeeper.create("/zk", null, Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
